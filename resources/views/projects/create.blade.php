    ...
    <div class="col-md-8 order-md-1">
      ...
      <form class="needs-validation" novalidate method="POST" action="/projects">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="address" placeholder="Title" v-model="name" required>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="address2" placeholder="Description" v-model="description">
        </div>
        <hr class="mb-4">
...
</div><script src="../dist/js/bootstrap.bundle.js"></script>
